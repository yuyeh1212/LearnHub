...
function LessonRoute({ accessToken, courseId, onRegister, onRequestAuthentication, onSignIn, onSignOut, user }: LessonRouteProps) {
  ...
  return <LessonPlayerPage accessToken={accessToken} authUser={user} course={courseOutline.course} chapters={courseOutline.chapters} currentLesson={currentLesson} onRegister={onRegister} onRequestAuthentication={onRequestAuthentication} onSelectLesson={selectLesson} onSignIn={onSignIn} onSignOut={onSignOut} />
}
